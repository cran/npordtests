...
\title{Gastwirth's ST Test}
\description{
\code{StTest} performs ST test.
}

\usage{StTest(formula, data, alpha = 0.05, na.rm = TRUE, verbose = TRUE)}
...
\item{statistic}{the ST test statistic.}
\item{mean}{the mean of the ST test statistic.}
\item{variance}{the variance of the ST test statistic.}
\item{Z}{the standardized test statistic.}
\item{p.value}{the p-value of the test.}
\item{alpha}{the level of significance.} 
\item{method}{the character string "ST test ".}
...
Gastwirth, J.L.(1965). Percentile modifications of two sample rank tests. \emph{Journal of the American Statistical Association}, \bold{60}, 1127-1141.
