...
\title{Jonckheere-Terpstra (JT) Test}
\description{
\code{JtTest} performs JT test.
}

\usage{JtTest(formula, data, alpha = 0.05, na.rm = TRUE, verbose = TRUE)}
...
\item{statistic}{the JT test statistic.}
\item{mean}{the mean of the JT test statistic.}
\item{variance}{the variance of the JT test statistic.}
\item{Z}{the standardized test statistic.}
\item{p.value}{the p-value of the test.}
\item{alpha}{the level of significance.} 
\item{method}{the character string "JT test".}
